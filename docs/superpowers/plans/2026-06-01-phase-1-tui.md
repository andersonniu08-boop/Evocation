...
class MockProvider(BaseProvider):
    def chat(self, messages: List[Message], tools: Optional[List[dict]] = None) -> LLMResponse:
        ...
        if "hello" in last or "hi" in last:
            return LLMResponse(content="Hello! I'm Evocation. How can I help you today?")
        return LLMResponse(
...
class ChatScreen(Screen):
    ...
    def on_input_submitted(self, event: Input.Submitted):
        ...
        conv.mount(Static(f"[bold green]Evocation:[/] {response_text}"))
...
def main():
    parser = argparse.ArgumentParser(prog="dog", description="Evocation — memory-augmented coding agent")
    ...
    config_parser = sub.add_parser("config", help="Configure Evocation")
    ...
    if args.command == "chat":
        ...
        app = EvocationApp(workspace=args.workspace)
        app.run()
